...
public class ReturnHomeDayGoal extends Goal {

    private final kingdomWorkerEntity mob;
    private final double speed;

    public ReturnHomeDayGoal(kingdomWorkerEntity mob, double speed) {
        this.mob = mob;
        this.speed = speed;
    ...
    public boolean canContinueToUse() {
        ...
        // keep going until we're close enough OR path is done
